...
Scene Scene::get4SphereScene()
{
	...
	NodePointer t1(new TranslationNode(0,3,-20, rootNode));
	...
	NodePointer t2(new TranslationNode(0,0,-20, rootNode));
	...
	NodePointer t3(new TranslationNode(3,0,-20, rootNode));
	...
	NodePointer t4(new TranslationNode(-3,0,-20, rootNode));
	...
	NodePointer t5(new TranslationNode(0,-3,-20, rootNode));
